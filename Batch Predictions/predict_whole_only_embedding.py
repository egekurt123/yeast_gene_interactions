...
results_ExE = iterate_over_proportion_only_embeddings(ExE, embeddings, proportion, predictive_models)
results_NxN = iterate_over_proportion_only_embeddings(NxN, embeddings, proportion, predictive_models)
results_ExN = iterate_over_proportion_only_embeddings(ExN, embeddings, proportion, predictive_models)


results = [results_ExE, results_NxN, results_ExN]


output_file = "output/only_embedding/results.txt"
